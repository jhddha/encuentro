...
2. ~~**TBD-001, la tasa de cambio.**~~ **Resuelto el 11 de agosto de 2026.** La tasa se registra por día en la configuración de la gestión y `assertDeclarableEvidence` exige que haya la del día del pago, con `EXCHANGE_RATE_MISSING` cuando falta. Un canal en moneda distinta a la de la gestión ya sirve, siempre que la tasa esté registrada.
