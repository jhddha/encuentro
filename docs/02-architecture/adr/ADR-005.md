...
Pagos manuales en v1 y separación modalidad/canal. Esta decisión se implementa conforme a requisitos, contratos y decisiones aprobadas de la versión 2.7.
