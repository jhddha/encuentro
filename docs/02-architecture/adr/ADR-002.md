...
PostgreSQL como fuente autoritativa e idempotencia transaccional. Esta decisión se implementa conforme a requisitos, contratos y decisiones aprobadas de la versión 2.7.
