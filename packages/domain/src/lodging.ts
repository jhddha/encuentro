 ...
 *
 *  - **HOS-001**: la cantidad de noches es fija y configurable por gestión. No
 *    se deriva de las fechas de llegada y salida de cada persona.
 *  - **HOS-002 y HOS-003**: llegar tarde **no** recorta el rango, **no** baja el
 ...
 * de que alguien revise un pago: HOS-005 sitúa la elección **después** de la
 ...
 *
 * Solo `HELD` expira. La regla completa es HOS-003 y DEC-004: una reserva
 ...
 * a usarla, y usarla sería exactamente la regla que HOS-003 prohíbe.
 */
 ...
 *
 * HOS-002: `actual_arrival_at` **no reescribe** la reserva. Se registra como
 ...
 *
 * HOS-008: la capacidad se controla por inventario y rango, no por un contador
